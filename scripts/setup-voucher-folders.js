...
/**
 * Скрипт для создания папок для ваучеров
 */

console.log('📁 Создание папок для ваучеров...\n');
...
folders.forEach(folder => {
  if (!fs.existsSync(folder)) {
    ...
    console.log(`📁 Папка уже существует: ${folder}`);
  }
});
...
fs.writeFileSync('VOUCHER_IMAGES_INSTRUCTIONS.md', instructions);

console.log('\n✅ Папки созданы!');
console.log('\n📋 Следующие шаги:');
console.log('1. Откройте в браузере: scripts/generate-voucher-images.html');
console.log('2. Нажмите "🚀 Сгенерировать все изображения"');
console.log('3. Скачайте все PNG файлы');
console.log('4. Сохраните в папки public/assets/tier1/, tier2/, tier3/, tier4/');
console.log('5. Проверьте инструкцию: VOUCHER_IMAGES_INSTRUCTIONS.md');

console.log('\n🎉 Готово к созданию изображений!');
